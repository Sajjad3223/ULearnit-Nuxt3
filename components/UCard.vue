  ...
  <div class="card">
    ...
    <div class="cardInfo">
      ...
      <div class="flex w-full items-center mt-2 space-x-2 space-x-reverse">
        ...
        <base-button color="danger" outline id="like" @click.prevent="addToFavorite" class="p-0 grid place-items-center rounded-lg btn-outline-danger w-9 h-9 hover:text-white">
          <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.6 1C9.29038 1 10.8323 1.84142 12 2.8C13.1677 1.84142 14.7096 1 16.4 1C20.0451 1 23 3.71049 23 7.05386C23 13.795 15.3274 17.721 12.7981 18.8321C12.2886 19.056 11.7114 19.056 11.2019 18.8321C8.67259 17.721 1 13.7948 1 7.0537C1 3.71033 3.95492 1 7.6 1Z" stroke="currentColor" stroke-width="2"/>
          </svg>
        </base-button>
      </div>
    </div>
...
<style scoped>
.card{
  @apply flex flex-col rounded-lg relative overflow-clip bg-gray-100 dark:bg-gray-800 shadow-md;
}
.cardImage{
