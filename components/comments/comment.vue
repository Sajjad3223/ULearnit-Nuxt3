<template>
  <article :class="['p-6 mb-6 text-base bg-white rounded-lg border-2 dark:border-gray-800 dark:bg-gray-900',{'mr-6 lg:mr-12':isChild}]">
      ...
      <div class="flex items-center">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
          <time pubdate datetime="2022-02-08"
                title="دوشنبه 16 ام بهمن">1401/11/16</time>
        </p>
      </div>
    ...
    <p class="text-gray-500 dark:text-gray-200">سلام استاد ، روز بخیر

      ببخشید توی این دوره از فروشگاه آنریل هم استفاده میشه یا همه پروژه ها خودسازه؟!</p>
