<template>
  <div>
    <div class="inline-flex items-center justify-center w-full">
      ...
      <span class="absolute px-3 font-medium text-gray-900 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900">پنل مدرس</span>
    </div>
    <ul class="options">
      <li>
        <NuxtLink to="/masterpanel/courses" class="option" active-class="active">
      ...
      <li>
        <NuxtLink to="/masterpanel/bundles" class="option" active-class="active">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        <NuxtLink to="/masterpanel/transactions" class="option" exact-active-class="active">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M12 13.7598H9C8.59 13.7598 8.25 13.4198 8.25 13.0098C8.25 12.5998 8.59 12.2598 9 12.2598H12C12.41 12.2598 12.75 12.5998 12.75 13.0098C12.75 13.4198 12.41 13.7598 12 13.7598Z" fill="currentColor"/>
            <path d="M12 9.75977H9C8.59 9.75977 8.25 9.41977 8.25 9.00977C8.25 8.59977 8.59 8.25977 9 8.25977H12C12.41 8.25977 12.75 8.59977 12.75 9.00977C12.75 9.41977 12.41 9.75977 12 9.75977Z" fill="currentColor"/>
            <path d="M5.9707 10.0098C5.4207 10.0098 4.9707 9.55977 4.9707 9.00977C4.9707 8.45977 5.4207 8.00977 5.9707 8.00977C6.5207 8.00977 6.9707 8.45977 6.9707 9.00977C6.9707 9.55977 6.5207 10.0098 5.9707 10.0098Z" fill="currentColor"/>
            <path d="M5.9707 14.0098C5.4207 14.0098 4.9707 13.5598 4.9707 13.0098C4.9707 12.4598 5.4207 12.0098 5.9707 12.0098C6.5207 12.0098 6.9707 12.4598 6.9707 13.0098C6.9707 13.5598 6.5207 14.0098 5.9707 14.0098Z" fill="currentColor"/>
          </svg>
          <span>مدیریت تراکنش ها</span>
        </NuxtLink>
      </li>
      <li>
        <NuxtLink to="/masterpanel/messages" class="option" exact-active-class="active">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        <NuxtLink to="/masterpanel/paymentInfo" class="option" exact-active-class="active">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M11.0991 19.03C10.9091 19.03 10.7191 18.96 10.5691 18.81C10.2791 18.52 10.2791 18.04 10.5691 17.75L11.7691 16.55C12.0591 16.26 12.5391 16.26 12.8291 16.55C13.1191 16.84 13.1191 17.32 12.8291 17.61L11.6291 18.81C11.4891 18.95 11.2991 19.03 11.0991 19.03Z" fill="currentColor"/>
      ...
      <li>
        <NuxtLink to="/masterpanel/walletRequests" class="option" exact-active-class="active">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        <NuxtLink to="/masterpanel/blog" class="option" exact-active-class="active">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        <NuxtLink to="/masterpanel/roadmap" class="option" exact-active-class="active">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
