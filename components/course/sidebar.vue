    ...
    <div class="courseDetails">
      ...
      <div class="detailItem">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M17.0809 14.1489C14.2909 12.2889 9.74094 12.2889 6.93094 14.1489C5.66094 14.9989 4.96094 16.1489 4.96094 17.3789C4.96094 18.6089 5.66094 19.7489 6.92094 20.5889C8.32094 21.5289 10.1609 21.9989 12.0009 21.9989C13.8409 21.9989 15.6809 21.5289 17.0809 20.5889C18.3409 19.7389 19.0409 18.5989 19.0409 17.3589C19.0309 16.1289 18.3409 14.9889 17.0809 14.1489Z" fill="white"/>
        </svg>
        <span>مدرس:</span>
        <strong>
          <NuxtLink :to="teacherResume" class="link">
            <span>{{ teacher }}</span>
          </NuxtLink>
        </strong>
      </div>
      ...
      <div class="detailItem">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M14.7295 2H9.26953V6.36H14.7295V2Z" fill="white"/>
          <path d="M16.2305 2V6.36H21.8705C21.3605 3.61 19.3305 2.01 16.2305 2Z" fill="white"/>
          ...
          <path d="M7.76891 2C4.66891 2.01 2.63891 3.61 2.12891 6.36H7.76891V2Z" fill="white"/>
        </svg>
        <span>تعداد ویدیو های دوره:</span>
        <strong>{{ videosCount }} قسمت</strong>
      </div>
      <div class="detailItem">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
