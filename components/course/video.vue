      ...
      <div class="actions">
        <div class="flex flex-row-reverse items-center space-x-2"
             v-if="userHasCourse ||
                   ...
                   coursePrice == 0 ||
                  episode.isFree">
          <base-button title="دانلود ویدئو" class="rounded-full" outline >
