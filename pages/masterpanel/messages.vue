<template>
  <div>
    ...
    <div className="w-full mt-4">
      <u-alert>
        <template #icon>
          <svg class="flex-shrink-0 inline w-5 h-5 ml-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <template #default>
          <span class="font-medium">اطلاع رسانی قسمت جدید!</span> قسمت جدید آموزش <NuxtLink to="/courses/1" class="font-bold hover:underline"> آنریل انجین جامع</NuxtLink> منتشر شد
        </template>
        <template #list>
          <li>
            عنوان این قسمت: آموزش استفاده از Spline
          </li>
        </template>
      </u-alert>
