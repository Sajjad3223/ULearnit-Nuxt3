<template>
  <div v-if="ticket !== undefined">
    <u-divider :title="`تیکت شماره ${ticket.id}`" />
        ...
        <div class="chat-container ">
          <ul class="chats ">
            ...
            <li v-for="m in ticket.messages" :key="m"
              ...
              <p>{{ m.message }}</p>
              <div class="flex text-sm opacity-70 mr-auto">
                <u-time :time="m.creationDate" dir="rtl"/>
                -
...
<!--              <button type="button" class="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
              ...
              <textarea v-model="sendTicketMessageData.message" id="chat" rows="3" class="block ml-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="پیام شما ..." required></textarea>
