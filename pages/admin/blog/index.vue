    ...
    <div class="w-full mt-4">
      <u-table>
        ...
        <template #table-header>
          ...
          <th scope="col" class="px-4 py-3">تعداد بازدید</th>
          <th scope="col" class="px-4 py-3">تعداد نظرات</th>
        ...
        <template v-slot:table-body="{showOption,hideAll}">
          <tr class="border-b dark:border-gray-700" v-for="(b,i) in posts">
            ...
            <td class="px-4 py-3">{{ b.writer.writerName }}</td>
...
import {GetPosts, PublishPost, RejectPost} from "~/services/blog.service";
