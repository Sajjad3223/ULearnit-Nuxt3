<template>
  <div>
    <u-divider title="دسته بندی های دوره های آموزشی"/>

    <admin-categories-create-modal v-model="categoryModal" @categoryCreated="onCategoryCreated"/>
    <admin-categories-add-child-modal ref="childCategoryModal" v-model="childCategoryModalModel" @childCategoryCreated="onCategoryCreated"/>
