<template>
  <div>
    <u-divider title="دسته بندی های نقشه راه"/>

    <admin-categories-create-modal v-model="categoryModal" @categoryCreated="onCategoryCreated" category-type="roadmap"/>
