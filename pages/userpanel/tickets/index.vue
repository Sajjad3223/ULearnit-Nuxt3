  ...
  <div>
    ...
    <div class="w-full mt-4">
      <u-table>
        ...
        <template #table-body>
          <tr class="border-b dark:border-gray-700" v-for="(t,i) in 10">
            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              <NuxtLink to="tickets/1" class="link" >آموزش جامع آنریل انجین</NuxtLink>
            </th>
            <td>1400/11/18</td>
            <td class="px-4 py-3">
              <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 whitespace-nowrap">در حال بررسی</span>
            </td>
            <td class="px-4 py-3 flex items-center justify-end">
              ...
              <div ref="options" id="apple-imac-27-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="apple-imac-27-dropdown-button">
                  <li>
                    <NuxtLink to="tickets/1" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">نمایش</NuxtLink>
                  </li>
                  <li>
