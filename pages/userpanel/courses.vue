<template>
  <div>
    ...
    <div class="w-full mt-4">
      <!-- Start coding here -->
      <div class="hidden bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 md:space-x-reverse p-4">
