...
<div>
  <Head>
    ...
    <Meta name="description" content="وبسایت یولرنیت وبسایتی تخصصی در جهت آموزش بازی سازی و بخش های مختلف این حوزه نظیر برنامه نویسی، مدل سازی سه بعدی، طراحی صحنه و دیگر موارد مربوطه مانند امکانات تیم یابی و تیم سازی، مشاهده و ثبت آگهی های شغلی مرتبط و امکانات متنوع دیگر" />
  </Head>
