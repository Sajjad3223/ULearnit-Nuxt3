      ...
      <template v-slot:table-options="{showFilter}">
        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 md:space-x-reverse flex-shrink-0">
          <div class="flex items-center space-x-3 space-x-reverse w-full md:w-auto">
            <base-button is-link link="questions/add">سوال جدید</base-button>
        ...
        <tr v-for="i in 10">
          <td class="p-2 bg-gray-50 dark:bg-gray-900 py-3 border border-transparent border-b-gray-700">
            ...
            <div class="flex items-center space-x-4 space-x-reverse px-4 ">
              <img class="w-10 h-10 rounded-full" src="/imgs/user.png" alt="">
              <div class="dark:text-white text-lg w-full">
                <NuxtLink to="questions/1" class="font-medium hover:underline underline-offset-4">در مورد سیستم مورد نیاز</NuxtLink>
                <div class="flex-1 text-sm text-gray-500 dark:text-gray-400 flex items-center mt-2 divide-x divide-x-reverse divide-gray-200 dark:divide-gray-700">
                  <span class="px-2 border-dotted whitespace-nowrap">آموزش جامع آنریل انجین</span>
                  <span class="px-2 border-dotted whitespace-nowrap">علی موسوی</span>
                  <span class="px-2 border-dotted whitespace-nowrap">1401/11/25</span>
                  <span class="px-2 border-dotted whitespace-nowrap">0 پاسخ</span>
                </div>
              </div>
              <u-badge color="success" class="mr-2">
