          ...
          <div class="w-full lg:w-1/3">
            <div class="p-4 border-2 rounded-lg border-gray-800">
              ...
              <ul class="max-w-md divide-y divide-gray-200 dark:divide-gray-700">
                <li class="pb-3 sm:pb-4" v-for="i in 5">
                  <div class="flex items-center space-x-4 space-x-reverse mt-2">

                    <div class="flex-1 min-w-0">
                      <NuxtLink to="/questions/1" class="text-sm font-medium text-gray-900 truncate dark:text-white hover:underline underline-offset-4">
                        در اتاق در پروژه عملی باز نمیشه
                      </NuxtLink>
